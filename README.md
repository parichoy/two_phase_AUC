...
For running the example code, one needs to run the R script file "AUC_code.R". The code is designed to run in a way that thethree files: "cohort.data.R", "case.control.data.R" and "AUC_code.R" are in the same local directory.
